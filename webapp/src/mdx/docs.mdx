...
> This file is the [README.md](https://github.com/rexcape/tailwindcss-antdesign-preset/blob/main/README.md) file, it may be updated after I find a better way to describe.
